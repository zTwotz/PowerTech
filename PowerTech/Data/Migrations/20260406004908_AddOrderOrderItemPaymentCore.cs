...
{
    /// <inheritdoc />
    public partial class AddOrderOrderItemPaymentCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Order_DiscountAmount", "[DiscountAmount] >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductNameSnapshot = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ProductSkuSnapshot = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
